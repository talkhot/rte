...
var Button = /** @class */ (function (_super) {
    ...
    Button.prototype.render = function () {
        ...
        return (React.createElement(Component, __assign({ type: "button", className: cn(className, (_a = {}, _a[styles === null || styles === void 0 ? void 0 : styles.button] = !component, _a)), "aria-pressed": active, "aria-label": ariaLabel }, rest), children));
    };
    return Button;
}(React.Component));
