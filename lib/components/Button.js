...
var Button = /** @class */ (function (_super) {
    ...
    Button.prototype.render = function () {
        ...
        return (React.createElement(Component, __assign({ type: "button", className: cn(className, (_a = {}, _a[styles.button] = !component, _a)), "aria-pressed": active, "aria-label": ariaLabel }, rest), children));
    };
    return Button;
}(React.Component));
