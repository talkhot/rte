...
function createToggle(execCommand, _a) {
    ...
    var Toggle = /** @class */ (function (_super) {
        ...
        Toggle.prototype.render = function () {
            ...
            return (React.createElement(Button, { className: className, title: title, onClick: this.handleClick, active: this.state.active, disabled: disabled || this.state.disabled, component: ButtonComponent }, children));
        };
        return Toggle;
    }(React.Component));
    return Toggle;
